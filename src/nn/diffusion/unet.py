...
from .nn_utils import (checkpoint, zero_module, normalization,
                       count_flops_attn, gamma_embedding)
    ...
    def __init__(
        ...
        self.emb_layers = nn.Sequential(
            ...
            nn.Linear(
                emb_channels,
                2 *
                self.out_channel if use_scale_shift_norm else self.out_channel,
            ),
        )
